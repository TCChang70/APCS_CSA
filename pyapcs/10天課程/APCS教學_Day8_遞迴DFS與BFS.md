...
> **解說**：3×3 迷宮，中間 (1,1) 是牆。最短路徑繞牆走：
> `(0,0) → (0,1) → (0,2) → (1,2) → (2,2)`，共 **4 步**。
...
> **解說**：樹的形狀像「1—2 分岔到 3、4，4 再分岔到 5、6」。最遠的兩點是 3 與 5（或 6），距離 = 3 條邊。
...
> **解說**：與前面「樹上的 DFS：算高度」是同一支程式。節點 1 有兩個子節點 2、3；節點 2 下面又有 4、5。
